...
?>
            ...
            <div class="doom" style="position:absolute">
                <audio id="audio2<?= $x ?>" gol="<?= $scode ?>" rel="<?= $songTitle ?>" pol="<?= $albumTitle ?>" class="gana" controls>
...
<?php
            $x++;
                ...
                while ($r = mysqli_fetch_array($result)) {
                    ...
                    $albumTitle = $r["album_title"];
                 ?> 
                           <div class="doom3" style="position:absolute">
                <audio id="audio4<?= $x ?>" gol="<?= $scode ?>" rel="<?= $songTitle ?>" pol="<?= $albumTitle ?>" class="gana" controls>
