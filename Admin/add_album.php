        ...
        $conn = mysqli_connect("127.0.0.1","root","","mp3");
                                  $rs=mysqli_query($conn,"select * from category where code='$code'");
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                           <br>
                                            <form method="post" action="addalbum.php?id=<?=$r["code"]?>" enctype="multipart/form-data">
                                                <label>Title:</label>
                                        ...
                                        <?php
                                            ...
                                            $rs=mysqli_query($conn,"select * from album where ccode='$code'");
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-lg-2">
                              <img src="../album/<?=$r["code"]?>.jpg" class= "img-fluid p" alt="user image">
                            </div>
                            <div class="col-lg-10">                          
                                  <table class="table table-borderless table-striped" >
                                  <tr>
                                                        
                                                       <tr><td><p  class="h"><?=$r["title"]?></p></td><td></td>
                                                       <td><a href="add_songs.php?id=<?=$r["code"]?>"><i class="fa fa-plus" ></i></a></td>
                                                       <td><a href="edit_album.php?id=<?=$r["code"]?>"><i class="fa fa-edit" style="color:green"></i></a></td>
                                                       <td><a href="deletealbum.php?id=<?=$r["code"]?>"><i class="fa fa-trash" style="color:red"></i></a></td>
