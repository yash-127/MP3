        ...
        <div class="col-md-12">
            <div class="songs-list">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div onclick="playsound(<?=$x?>)">
                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                            <i class="bi bi-music-note me-3"></i>
                            <div>
                                <h5 class="mb-1"><?=$row["song_title"]?></h5>
                                <small class="text-muted"><?=$row["album_title"]?></small>
                            </div>
                            <div class="doom" style="position:absolute">
                                <audio id="audio<?=$x?>" class="gana" controls>
                                    <source src="album/<?=$row["song_code"]?>/<?=$row["sn"]?>.mp3" type="audio/mpeg">
                                </audio>
                            </div>
                        </div>
                    </div>
...
<div class="col-12">
<h1 style="display:inline;" class="hi">Randoms</h1>
<a href="browse.php"><p class="pi"> <small  class="text-muted">Show all</small></p></a>
</div><br>
...
$rs = mysqli_query($conn,"select * from album where code<>'$id' LIMIT 4");
$i=0;
